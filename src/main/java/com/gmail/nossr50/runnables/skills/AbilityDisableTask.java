...
public class AbilityDisableTask implements Runnable {
...
//        ParticleEffectUtils.playAbilityDisabledEffect(player);
        ...
        if(!mcMMO.isServerShutdownExecuted()) {
            mcMMO.getScheduler().getImpl().runLater(new AbilityCooldownTask(mcMMOPlayer, ability), PerksUtils.handleCooldownPerks(player, ability.getCooldown()), TimeUnit.SECONDS);
        }
    }
